$(document).ready(function() {
    ...
    $("#left_i").click(function() {
        ...
        if (prev.length != 0) {
            ...
            var img = $(".navigation").children().eq(3).data("img");
            var msg = $(".navigation").children().eq(3).data("msg");
            $(".slider").children().eq(3).attr("src", `img/lg/${img}`);
            $(".slider").children().eq(1).text(msg);
            if ($(".active")) {
                $(".active").removeClass("active");
            }
            $(".navigation").children().eq(3).children(3).eq(1).addClass("active");
        }
